...
def deriveKernelArguments(scope, identifiers, localVars, loopVars, whiteList=[], isLoopKernelArg=False, deviceptrNames=[]):
    """
...
def updateContextFromDeviceProcedures(deviceProcedures,index,hipContext,fContext):
    ...
    for stprocedure in deviceProcedures:
        ...
        kernelArgs, cKernelLocalVars, macros, inputArrays, localCpuRoutineArgs =\
          deriveKernelArguments(scope,identifiers,localLValues,loopVars,dummyArgs,False,deviceptrNames=[])
        #print(argNames)
...
def renderTemplates(outputFilePrefix,hipContext,fContext):
    ...
    utils.logging.logInfo(LOG_PREFIX,"renderTemplates",msg)
