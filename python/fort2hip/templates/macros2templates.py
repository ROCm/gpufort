...
class TemplateGenerator:
    def iterate_macro_files(template_dir,
                            macro_files,
                            macro_filters,
                            action):
...
def create_autogenerated_templates(template_dir
    ...
    iterate_macro_files(template_dir,
                        macro_files,
                        macro_filters,
                        create_autogenerated_templates_action_)
...
def delete_autogenerated_templates(template_dir
    ...
    iterate_macro_files(template_dir,
                        macro_files,
                        macro_filters,
                        delete_autogenerated_templates_action_)
...
macro_filters = [
  re.compile("|".join(\
r"""render_derived_type_copy_array_member_routines
...
convert_macros_to_templates(root_dir,
                            macro_files,
                            macro_filters)
