...
fort2x_dir = os.path.dirname(_file__)
...
class CodeGenerator:
    ...
    def _create_cpp_guard(cpp_file_name):
        return "_{}_".format("".join(e for e in cpp_file_name if e.isalnum() else "_")).upper()
    @staticmethod
    ...
    def _traverse_scanner_tree(self):
        ...
        def traverse_node_(stnode)
            ...
            if isinstance(stnode,scanner.STRoot):
                ...
                if stnode.parent == scanner.STRoot:
                    ...
                    fortran_modulegen.default_modules 
                else:
        ...
        traversed = True
   def generate_cpp_files(self,main_cpp_file_path):
       ...
       :note: Always the main C++ file even if no code was generated
       ...
       self.main_filegen.generate_file(os.path.join(output_dir,
       # 
