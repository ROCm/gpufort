...
class DerivedTypeGenerator:
    ...
    def render_derived_type_definitions_f03(self):
        snippets = [
                   render.render_derived_types_f03(self.itypes,
                                                          self.interop_suffix),
                   ]
        return snippets 
    def render_derived_type_routines_f03(self):
        return [
               render.render_derived_type_size_bytes_routines_f03(self.itypes,
                                                                         self.used_modules,
                                                                         self.interop_suffix),
               render.render_derived_type_copy_scalars_routines_f03(self.itypes,
                                                                           "in",
                                                                           self.used_modules,
                                                                           self.interop_suffix),
               render.render_derived_type_copy_scalars_routines_f03(self.itypes,
                                                                           ...
                                                                           self.used_modules,
                                                                           self.interop_suffix),
               render.render_derived_type_copy_array_member_routines_f03(self.itypes,
                                                                                "in",
                                                                                "",
                                                                                self.used_modules,
               ...
               render.render_derived_type_copy_array_member_routines_f03(self.itypes,
                                                                                ...
                                                                                self.orig_var,
                                                                                self.interop_var),
               render.render_derived_type_init_array_member_routines_f03(self.itypes,
                                                                                "",
                                                                                self.used_modules,
                                                                                self.error_check,
                                                                                self.interop_suffix,
                                                                                self.orig_var,
                                                                                self.interop_var),
               render.render_derived_type_destroy_array_member_routines_f03(self.itypes,
                                                                                   "",
                                                                                   self.used_modules,
                                                                                   self.synchronize_queue,
                                                                                   self.error_check,
               ...
               render.render_derived_type_destroy_array_member_routines_f03(self.itypes,
                                                                                   ...
                                                                                   self.orig_var,
                                                                                   self.interop_var),
               render.render_derived_type_destroy_routines_f03(self.itypes,
                                                                      "",
                                                                      self.used_modules,
                                                                      self.interop_suffix,
                                                                      self.orig_var,
