...
def generate_gpufort_headers(output_dir):
    ...
    render.render_gpufort_reduction_header_file(gpufort_reduction_header_file_path)
...
def generate_gpufort_sources(output_dir):
    ...
    util.logging.log_leave_function(opts.log_prefix,"generate_gpufort_sources")
