...
def _modify_array_expressions(ttnode,ttvalues,scope,**kwargs):
    ...
    """
    fortran_style_array_access,_ = util.kwargs.get_value("fortran_style_array_access",opts.fortran_style_array_access,**kwargs)

    loop_ctr = transformations.expand_all_array_expressions(ttnode, scope, fortran_style_array_access)
