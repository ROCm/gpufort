...
class TestRenderGpufortTypes(unittest.TestCase):
    ...
    def test_0_render_gpufort_fixed_array_header(self):
        print(fort2x.render.generate_code(
          "gpufort_fixed_array.template.h",
          context={
            "max_rank": max_rank
          }));
    def test_1_render_gpufort_fixed_array_source(self):
        print(fort2x.render.generate_code(
          "gpufort_fixed_array.template.cpp",
          context={
            "max_rank": max_rank
          }));
