...
#print(translator.arithmeticExpression.parseString("(b+c)")[0].c_str())
#print(translator.arithmeticExpression.parseString("0.0d0")[0].c_str())
#print(translator.arithmeticExpression.parseString("0.d0+5")[0].c_str())
...
#print(translator.arithmeticExpression.parseString("CMPLX( rr*COS(arg), rr*SIN(arg) ,kind=DP)")[0].c_str())
#print(translator.arithmeticExpression.parseString("1.0_DP + 0.05_DP * CMPLX( rr*COS(arg), rr*SIN(arg) ,kind=DP)")[0].c_str())
#print(translator.arithmeticExpression.parseString("wfcatom_d(ig,ipol,ibnd) * ( 1.0_DP + 0.05_DP * CMPLX( rr*COS(arg), rr*SIN(arg) ,kind=DP))")[0].c_str())
...
#print(translator.arithmeticExpression.parseString("sendsiz + (cuf_i-1)*nppx + i*nppx*ncpx")[0].c_str())
