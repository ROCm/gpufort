...
#        self.assertEqual(b["c_type"],"double")
    ...
    def test_8_indexer_check_accessibility(self):
        ...
        self.assertTrue("private" in private_proc1["attributes"])
        self.assertFalse("public" in private_proc1["attributes"])
        self.assertTrue("public" in public_proc1["attributes"])
        self.assertFalse("private" in public_proc1["attributes"])
        # types
        ...
        self.assertTrue("public" in public_type1["attributes"])
        self.assertTrue("public" in public_type2["attributes"])
        self.assertTrue("private" in private_type1["attributes"])
        self.assertFalse("private" in public_type1["attributes"])
        self.assertFalse("private" in public_type2["attributes"])
        self.assertFalse("public" in private_type1["attributes"])
        # variables
        ...
        self.assertTrue("public" in public_var1["attributes"])
        self.assertTrue("public" in public_var2["attributes"])
        self.assertTrue("private" in private_var1["attributes"])
        self.assertFalse("private" in public_var1["attributes"])
        self.assertFalse("private" in public_var2["attributes"])
        self.assertFalse("public" in private_var1["attributes"])
        #
        for modname in ["public_mod1","public_mod2"]:
            ...
            self.assertIsNotNone(public_type1)
            self.assertTrue("private" in private_type1["attributes"])
            self.assertTrue("private" in private_type2["attributes"])
            self.assertTrue("public" in public_type1["attributes"])
            self.assertFalse("public" in private_type1["attributes"])
            self.assertFalse("public" in private_type2["attributes"])
            self.assertFalse("private" in public_type1["attributes"])
            # variables
            ...
            self.assertIsNotNone(public_var1)
            self.assertTrue("private" in private_var1["attributes"])
            self.assertTrue("private" in private_var2["attributes"])
            self.assertTrue("public" in public_var1["attributes"])
            self.assertFalse("public" in private_var1["attributes"])
            self.assertFalse("public" in private_var2["attributes"])
            self.assertFalse("private" in public_var1["attributes"])
