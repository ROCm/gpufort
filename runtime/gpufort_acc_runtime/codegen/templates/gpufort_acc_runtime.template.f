...
{% set suffix = tuple[0] + "_" + dims|string %}                                                              
    function gpufort_acc_present_{{suffix}}(hostptr,async,copy,copyin) result(deviceptr)
      use iso_c_binding
      ...
      !
      deviceptr = gpufort_acc_present_b(c_loc(hostptr),{{size}}{{tuple[1]}}_8,async,copy,copyin)
    end function
