...
{0}  {6}
{0});
#if defined(SYNCHRONIZE_ALL_KERNELS) || defined(SYNCHRONIZE_{1})\n{0}HIP_CHECK(hipStreamSynchronize(stream));
#elif defined(SYNCHRONIZE_DEVICE_ALL_KERNELS) || defined(SYNCHRONIZE_DEVICE_{1})\n{0}HIP_CHECK(hipDeviceSynchronize());\n#endif""".format(\
